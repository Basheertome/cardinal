where = {
	...
	map: {
		start: function(watch) {
			...
			watch.mapgroup.attr({'mask': watch.mask});
	...
	transit: {
		start: function(watch) {
			...
			watch.linemasks = watch.canvas.group(
				watch.canvas.rect(watch.x - watch.width/2, watch.y - watch.width/2, watch.width, watch.width).attr({fill: '#fff'}),
				watch.canvas.rect(
			...
			watch.lines = watch.canvas.group(
				watch.canvas.line(
					...
					.animate({transform: 's' + (watch.width - 45) + ',1'}, 125, mina.backout, function() {
						watch.lines.add(watch.canvas.line(
							watch.x - .5,
						...
						watch.linemasks.add(watch.canvas.rect(
							watch.x - 42,
							watch.y - (watch.width * (1/9)) - 8,
							84,
							16)
							.attr({'class': 'linemasks'}));
						watch.linelabels.add(watch.canvas.text(watch.x, watch.y - (watch.width * (1/9)) + 4.25, 'Kendall / MIT')
						...
						watch.lines.add(watch.canvas.line(
							...
							.animate({transform: 's' + (watch.width - 52) + ',1'}, 125, mina.backout, function() {
								...
								watch.linemasks.add(watch.canvas.rect(
									...
									16)
									.attr({'class': 'linemasks'}));
								watch.linelabels.add(watch.canvas.text(watch.x, watch.y - (watch.width * (2/9)) + 3.25, 'Central Square')
								...
								watch.lines.add(watch.canvas.line(
									...
									.animate({transform: 's' + (watch.width - 70) + ',1'}, 125, mina.backout, function() {
										...
										watch.linemasks.add(watch.canvas.rect(
											...
											14)
											.attr({'class': 'linemasks'}));
										watch.linelabels.add(watch.canvas.text(watch.x, watch.y - (watch.width * (3/9)) + 3, 'Harvard')
										...
										watch.linemasks.add(watch.canvas.rect(
											...
											14)
											.attr({'class': 'linemasks'}));
										watch.linelabels.add(watch.canvas.text(watch.x, watch.y + (watch.width * (3/9)) + 3, 'Broadway')
											.attr({'font-size': '10px', 'class': 'linelabels'})
											.animate({'opacity': '1'}, 125));
									}));
								watch.linemasks.add(watch.canvas.rect(
									...
									16)
									.attr({'class': 'linemasks'}));
								watch.linelabels.add(watch.canvas.text(watch.x, watch.y + (watch.width * (2/9)) + 3.25, 'South Station')
									.attr({'font-size': '12px', 'class': 'linelabels'})
						...
						watch.linemasks.add(watch.canvas.rect(
							...
							16)
							.attr({'class': 'linemasks'}));
						watch.linelabels.add(watch.canvas.text(watch.x, watch.y + (watch.width * (1/9)) + 4.25, 'Downtown Crossing')
							.attr({'font-size': '15px', 'class': 'linelabels'})
							.animate({'opacity': '1'}, 125));
					})
			);
			...
			watch.lines.attr({mask: watch.linemasks});
		},
