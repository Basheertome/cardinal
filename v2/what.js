...
function setCumulativePie(watch, pie, offset, start, stop, speed) {
	...
	pie.leftedge.animate({transform: 'r' + start + ',' + watch.x + ',' + watch.y}, speed);
	pie.rightedge.animate({transform: 'r' + stop + ',' + watch.x + ',' + watch.y}, speed, function() {
		if (stop-start > 20) {
