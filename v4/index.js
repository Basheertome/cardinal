...
function setup(watch) {
	...
	watch.buttonlabel1 = [
		...
		watch.canvas.text(watch.x + watch.width*.66 + 10, watch.y + 3, '●')
			.transform('t0,' + -60)
			.attr({'class': 'buttonlabel'}),
		watch.canvas.text(watch.x + watch.width*.66 + 20, watch.y + 3, '●')
			.transform('t0,' + -60)
			.attr({'class': 'buttonlabel'}),
		watch.canvas.text(watch.x + watch.width*.66 + 30, watch.y + 3, '●')
			.transform('t0,' + -60)
			.attr({'class': 'buttonlabel'})
	];
	watch.buttonlabel2 = [
